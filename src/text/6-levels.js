...
Object.assign(STR.en, {
  ...
  // the guide's later steps — one for each thing the game hands over after the first month
  gt_infra:'Upgrade something the country runs on',
  gw_infra:'Open Build. The grid, the water, the housing — each has levels, and each level costs more and takes longer than the last. Start with whatever is hurting most.',
  gt_medals:'Look at your medals',
  gw_medals:'Open Progress → Medals. Each one is earned once and pays experience, and experience is what raises your level. It is a list of things worth doing.',
  gt_port:'Make a port bigger',
  gw_port:'Open Trade → Ports. Everything you grow or make leaves through here. When the docks are full, the rest of the economy is just waiting.',
  gt_deal:'Sign your first trade route',
  gw_deal:'Open Trade → Partners. A neighbour will buy what you make, or sell you what you need. Read what each one wants in return.',
  gt_school:'Build schools or a clinic',
  gw_school:'Open People → Schools & clinics. Educated, healthy people work more, earn more and riot less. It takes years to show, so start early.',
  gt_factory:'Build your first factory',
  gw_factory:'Open Trade → Resources. Digging things up earns dollars; factories employ people. People with work are what hold a country together.',
...
Object.assign(STR.ar, {
  ...
  gt_infra:'طوّر شيئاً يقوم عليه البلد',
  gw_infra:'افتح «البناء». الشبكة والمياه والإسكان — لكلٍّ منها مستويات، وكل مستوى أغلى وأطول من الذي قبله. ابدأ بما يؤلم أكثر.',
  gt_medals:'انظر إلى أوسمتك',
  gw_medals:'افتح «التقدّم» ← «الأوسمة». كل وسام يُنال مرة واحدة ويُدفع خبرةً، والخبرة هي ما يرفع مستواك. إنها قائمة بما يستحق أن يُفعل.',
  gt_port:'وسّع ميناءً',
  gw_port:'افتح «التجارة» ← «الموانئ». كل ما تزرعه أو تصنعه يخرج من هنا. وحين تمتلئ الأرصفة يقف باقي الاقتصاد ينتظر.',
  gt_deal:'وقّع أول طريق تجاري لك',
  gw_deal:'افتح «التجارة» ← «الشركاء». جارٌ يشتري ما تصنعه، أو يبيعك ما تحتاجه. اقرأ ما يطلبه كلٌّ منهم في المقابل.',
  gt_school:'ابنِ مدارس أو عيادة',
  gw_school:'افتح «الناس» ← «المدارس والعيادات». المتعلّمون الأصحّاء يعملون أكثر ويكسبون أكثر ويغضبون أقل. أثرها يظهر بعد سنوات، فابدأ باكراً.',
  gt_factory:'ابنِ أول مصنع لك',
  gw_factory:'افتح «التجارة» ← «الموارد». استخراج ما في الأرض يكسب دولارات؛ والمصانع توظّف الناس. والناس الذين يعملون هم ما يمسك البلد.',
