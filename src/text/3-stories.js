...
const WHY = {
  en:{ fxUp:'Dollar +{0}%', fxDown:'Dollar {0}%', payDown:'Salary lost ${0}', payUp:'Salary gained ${0}', trustDown:'Trust −{0}', trustUp:'Trust +{0}', angerUp:'Anger +{0}', angerDown:'Anger −{0}',
    print:'You printed {0}bn lira', reserves:'Few dollars left in the bank', reservesGood:'Plenty of dollars in the bank', deficit:'Government cash below zero', lowTrust:'People don’t trust the government', highTrust:'People trust the government', intervene:'You sold dollars to protect the lira', fxWindow:'The central bank sold dollars for lira', shock:'A crisis shook the lira', base:'Normal price rises',
  ...
  ar:{ fxUp:'الدولار +{0}%', fxDown:'الدولار {0}%', payDown:'الراتب خسر {0}$', payUp:'الراتب ربح {0}$', trustDown:'الثقة −{0}', trustUp:'الثقة +{0}', angerUp:'الغضب +{0}', angerDown:'الغضب −{0}',
    print:'طبعتَ {0} مليار ليرة', reserves:'دولارات قليلة في المصرف', reservesGood:'دولارات كثيرة في المصرف', deficit:'نقد الحكومة تحت الصفر', lowTrust:'الناس لا يثقون بالحكومة', highTrust:'الناس يثقون بالحكومة', intervene:'بعتَ دولارات لحماية الليرة', fxWindow:'المصرف المركزي باع دولارات مقابل ليرات', shock:'أزمة هزّت الليرة', base:'ارتفاع الأسعار الطبيعي',
    t_bread:'سياسة الخبز', t_fuel:'سياسة الوقود', t_pay:'الرواتب مقارنة بتوقعات الناس', t_power:'الكهرباء', t_prices:'الأسعار', t_security:'الانتشار الأمني', t_tax:'الجباية الصارمة', t_anger:'المحافظات الغاضبة', t_jobs:'العمل', t_bar:'الناس صاروا يتوقعون أكثر', t_debt:'نقد الحكومة تحت الصفر بكثير', t_decrees:'مراسيمك',
    a_trust:'ثقة منخفضة', a_pay:'رواتب منخفضة', a_power:'التقنين', a_subsidies:'خفض الدعم', a_security:'مستوى الأمن', a_damage:'دمار الحرب', a_jobs:'ناس بلا عمل', a_bar:'الناس صاروا يتوقعون أكثر', a_prices:'ارتفاع الأسعار', a_local:'مظالم محلية', a_neighbors:'الغضب ينتقل من الجيران', b_trust:'الناس يثقون بك', b_pay:'رواتب أفضل', b_power:'كهرباء أفضل', b_subsidies:'الدعم', b_security:'الانتشار الأمني', b_damage:'إعادة الإعمار', b_jobs:'المصانع توظّف', b_bar:'التوقعات', b_prices:'استقرار الأسعار', b_local:'اتفاقات ومشاريع محلية', b_neighbors:'جيران هادئون',
