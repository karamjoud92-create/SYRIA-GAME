...
const LEGACY_TXT = {
 en:{ names:{ Stability:'Peace', Livelihoods:'Living standards', Reconstruction:'Rebuilding', Institutions:'Honest government', Solvency:'Money', Sovereignty:'Independence' },
 ...
 ar:{ names:{ Stability:'السلم', Livelihoods:'مستوى المعيشة', Reconstruction:'إعادة الإعمار', Institutions:'نزاهة الحكومة', Solvency:'المال', Sovereignty:'الاستقلال' },
...
const MISSION_TXT = {
 winter:{ icon:'snowflake', en:['Keep the lights on','It’s winter 2027 and the grid is failing. Reach 7 hours of electricity a day within 8 seasons, with no province in revolt.','Lesson: power stations take time. Invest early, before you see results.'],
 ...
 lira:{ icon:'exchange', en:['Save the lira','The last government printed money like crazy. A dollar costs 260 lira and prices rise 90% a year. Within 8 seasons, get the dollar under 340 lira and yearly price rises under 30%.','Lesson: printing money is a trap. Breaking out of it hurts at first.'],
 ...
 bread:{ icon:'wheat', en:['Feed the country','Drought has hit the northeast. Wheat imports will cost double for 8 seasons. Finish with trust at 40+, at least $250M in the bank, and Hasakeh’s anger below 55.','Lesson: food is a supply chain. Farms, silos, fuel and dollars all have to work.'],
 ...
 capital:{ icon:'building', en:['Calm the capital','Rural Damascus is close to revolt and the city is restless. Within 8 seasons, get Rural Damascus under 50 and Damascus city under 45.','Lesson: the capital and its countryside are different places with different problems.'],
...
const PERSONA_TXT = {
 rana:{ icon:'worker', prov:'aleppo', en:['Rana, 34','Teacher in Aleppo, two kids'], ar:['رنا، 34 عاماً','معلّمة في حلب، ولديها طفلان'] },
 khaled:{ icon:'worker', prov:'hasakeh', en:['Abu Khaled, 52','Wheat farmer in Hasakeh'], ar:['أبو خالد، 52 عاماً','مزارع قمح في الحسكة'] },
 hiba:{ icon:'worker', prov:'rif', en:['Hiba, 27','Returned from Lebanon to Rural Damascus'], ar:['هبة، 27 عاماً','عادت من لبنان إلى ريف دمشق'] },
 samer:{ icon:'worker', prov:'damascus', en:['Samer, 41','Runs a phone repair shop in Damascus'], ar:['سامر، 41 عاماً','يدير محل تصليح هواتف في دمشق'] },
};
const PERSONA_LINES = {
