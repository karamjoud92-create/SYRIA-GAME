...
Object.assign(STR.en, {
 ...
 oilTitle:'Oil', oilProd:'{0} thousand barrels a day', kbbl:'{0}k', oilAccess:'Fields you control: {0}%. Security in the east: {1}%.',
 ...
 polCapexName:'Power stations', polCrackdownName:'Border crackdown', dChains:'Supply chains', subFirms:'Companies',
 startBtn:'Start rebuilding', startTxt:'You are the president of Syria in 2027. Twenty years, fourteen provinces, and a country to put back together.',
 lvlOpensAt:'What level {0} opens', lvlLadder:'The road to a rebuilt country', lvlTargets:'Your targets', lvlTargetsSub:'Meet all of these and a national plan starts. When it finishes, the country levels up and more of the game opens.',
...
Object.assign(STR.ar, {
 ...
 oilTitle:'النفط', oilProd:'{0} ألف برميل يومياً', kbbl:'{0} ألف', oilAccess:'الحقول تحت سيطرتك: {0}%. الأمن في الشرق: {1}%.',
 ...
 polCapexName:'محطات الكهرباء', polCrackdownName:'ضبط الحدود', dChains:'سلاسل الإمداد', subFirms:'الشركات',
 startBtn:'ابدأ إعادة البناء', startTxt:'أنت رئيس سوريا عام 2027. عشرون سنة، وأربع عشرة محافظة، وبلد يُعاد بناؤه.',
 lvlOpensAt:'ما يفتحه المستوى {0}', lvlLadder:'الطريق إلى بلد مُعاد بناؤه', lvlTargets:'أهدافك', lvlTargetsSub:'حقّق هذه كلها فتبدأ خطة وطنية. وعند انتهائها ترتفع البلاد مستوى وينفتح المزيد من اللعبة.',
...
GLOSS.score = { icon:'trophy', en:{ name:'Legacy score', short:'Score', what:'One number for how well the country is doing, from 0 to 100.', why:'It’s how history will judge you. It changes every month.', fix:'Keep the peace, raise living standards, rebuild, fight corruption, keep money in the bank, and don’t give away too much independence.' },
...
TUT.en = [
 ['','You are the new president of Syria','The war is over. Cities are damaged, most people get four hours of electricity a day, and the money is almost worthless. Your job: rebuild the country, for as long as you can.'],
 ['clock','Time keeps moving','Press and the months start ticking. Speed up or pause any time. Every choice you make takes effect right away, and your legacy score changes every month.'],
 ['','The map shows each province','Colors show how angry people are. Tap a province to see its problems and its big project.'],
 ...
 ['','How you lose','You run out of dollars. Four provinces revolt at once. The army takes over. Or Suwayda and the east break away. Crises pause the clock so you can think.'],
...
TUT.ar = [
 ['','أنت رئيس سوريا الجديد','انتهت الحرب. المدن مدمّرة، ومعظم الناس يحصلون على أربع ساعات كهرباء، والعملة شبه بلا قيمة. مهمتك: أن تعيد بناء البلاد لأطول مدة ممكنة.'],
 ['clock','الوقت لا يتوقف','اضغط فتبدأ الأشهر بالمرور. سرّع أو أوقف متى شئت. كل قرار تتخذه ينفَّذ فوراً، ونقاط إرثك تتغيّر كل شهر.'],
 ['','الخريطة تُظهر كل محافظة','الألوان تُظهر مدى غضب الناس. اضغط على محافظة لترى مشاكلها ومشروعها الكبير.'],
 ...
 ['','كيف تخسر','تنفد دولاراتك. أربع محافظات تتمرّد معاً. الجيش يستولي على الحكم. أو تنفصل السويداء والشرق. الأزمات توقف الساعة لتفكّر.'],
...
MISSION_TXT.trade = { icon:'ship', en:['Open for business','Syria earns about $120M a year from exports, transit and investment. Within 4 years, get it to $250M a year.','Lesson: selling abroad needs things to sell, ports to ship them, and partners to buy them.'],
...
const INV_TXT = {
 oilwells:{ icon:'barrel', en:['Repair oil wells','+25 thousand barrels a day of capacity. Only helps if you control the fields and the east is calm.'], ar:['إصلاح آبار النفط','+25 ألف برميل يومياً من القدرة. يفيد فقط إذا سيطرت على الحقول وكان الشرق هادئاً.'] },
 refinery:{ icon:'factory', en:['Expand the refineries','Refine 20 thousand more barrels a day at home. Refined fuel is worth far more than crude — but only if the oil policy says to use it at home.'], ar:['توسيع المصافي','تكرير 20 ألف برميل إضافية يومياً محلياً. الوقود المكرّر أغلى بكثير من الخام — لكن فقط إذا كانت سياسة النفط تقول باستخدامه محلياً.'] },
 gasfield:{ icon:'flame', en:['Develop a gas field','+3 million m³ a day of gas for power plants. Ready in 18 months.'], ar:['تطوير حقل غاز','+3 مليون م³ يومياً من الغاز لمحطات الكهرباء. يجهز خلال 18 شهراً.'] },
 offshore:{ icon:'water', en:['Drill for offshore gas','A 50/50 bet. In 3 years you find a big gas field under the sea, or nothing.'], ar:['التنقيب عن الغاز البحري','مقامرة 50/50. خلال 3 سنوات تجد حقل غاز كبيراً تحت البحر، أو لا شيء.'] },
 phosphate:{ icon:'pickaxe', en:['Expand phosphate mines','Mining exports +35%.'], ar:['توسيع مناجم الفوسفات','صادرات التعدين +35%.'] },
 farm:{ icon:'olive', en:['Olive oil and cotton program','Seeds, presses and buyers abroad. Farm exports grow.'], ar:['برنامج الزيتون والقطن','بذار ومعاصر ومشترون في الخارج. تنمو الصادرات الزراعية.'] },
};
Object.assign(INV_TXT, {
 textiles:{ icon:'spool', en:['Textile mills and garment workshops','Syria used to clothe the region. Cheap to restart, and it hires more people per dollar than anything else you can build.'],
 ...
 food:{ icon:'bowl', en:['Food processing and canning','Turn the harvest into something that keeps. Jobs in the farming provinces, and a smaller wheat bill every year.'],
 ar:['تصنيع الأغذية والتعليب','حوّل المحصول إلى شيء يُخزَّن. وظائف في محافظات الزراعة، وفاتورة قمح أقل كل عام.'] },
 pharma:{ icon:'pill', en:['Medicine factories','Syria made most of its own medicine before the war. Skilled work, steady exports, and hospitals that stop begging.'],
 ar:['معامل الأدوية','كانت سوريا تصنع معظم دوائها قبل الحرب. عمل يحتاج مهارة، وصادرات ثابتة، ومشافٍ تكفّ عن الاستجداء.'] },
 cement:{ icon:'brick', en:['Cement and building materials','Every lira you spend on rebuilding goes further when the cement is made here instead of imported.'],
 ar:['الإسمنت ومواد البناء','كل ليرة تنفقها على الإعمار تمتدّ أكثر عندما يُصنع الإسمنت هنا بدل استيراده.'] },
 telecom:{ icon:'antenna', en:['Phone and internet network','Expensive, and it earns little directly. But taxes get collected, businesses find customers, and the whole economy speeds up.'],
 ar:['شبكة الهاتف والإنترنت','مكلفة، ولا تكسب كثيراً بنفسها. لكن الضرائب تُجبى، والتجار يجدون زبائن، ويتسارع الاقتصاد كله.'] },
 logistics:{ icon:'truck', en:['Trucks, roads and warehouses','Nothing you make is worth anything until it can reach a buyer. This is what unjams the ports.'],
 ar:['الشاحنات والطرق والمستودعات','لا قيمة لما تصنعه حتى يصل إلى مشترٍ. هذا ما يفكّ ازدحام الموانئ.'] },
 coldchain:{ icon:'snowflake', en:['Cold storage and refrigerated transport','Right now a share of every harvest rots between the field and the ship. This stops that.'],
 ar:['التبريد والنقل المبرّد','اليوم يتلف جزء من كل محصول بين الحقل والسفينة. هذا يوقف ذلك.'] },
 packaging:{ icon:'box', en:['Packaging and grading','The same olive oil in a proper bottle with a label is worth more abroad. Cheap, and it lifts everything you sell.'],
 ar:['التعبئة والفرز','زيت الزيتون نفسه في عبوة لائقة بعلامة يساوي أكثر في الخارج. رخيص، ويرفع قيمة كل ما تبيعه.'] },
 tourism:{ icon:'institution', en:['Hotels and the old cities','Damascus, Palmyra, the coast. Visitors pay in dollars and need no ship, but nobody comes to a country that is angry or dark.'],
