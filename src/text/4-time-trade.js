...
Object.assign(STR.en, {
  ...
  afterN:'after {0} as president', missionsTxt:'48-month challenges. Each one teaches one system.', seasonsLeft:'{0} left', quiet:'A quiet month.',
  choices:'Your choices', monthsN:'{0} months', months1:'1 month', soon:'any day now', inTime:'in {0}',
  ...
  inSixMonths:'in 6 months', perYear:'every 12 months', monthNo:'Month {0}',
  level:'Level', levelN:'Level {0}', levelOf10:'Level {0} of 10',
  ...
  decFx:'Dollars are piling up in the bank while the budget has no lira in it',
  ...
  chain6:'People in work → shops with customers → tax the state can actually collect → salaries paid in lira',
  chainHelp:'Nothing in this country has only one effect. That is the whole game.',
  taxBase:'What you can tax at home',
  taxBaseTxt:'Oil and phosphate pay you in dollars. Lira comes from people in steady work, shops with customers, and factories that keep books. Every factory you open and every person back in work makes this bigger.',
  taxBaseNow:'{0}% of what it was when you started',
  taxBaseFirms:'Factories paying company tax: {0}',
  taxBaseJobs:'{0} out of every 100 working-age people have no steady job',
  giftFx:'Sell dollars for lira',
  ...
  svcSchoolsTxt:'Classrooms, teachers and books for the children who lost so much school to the war.',
  svcClinicsTxt:'Doctors, medicine and a hospital bed within reach. Costs dollars every month to keep running.',
  ...
  barHigh:'People compare you to normal countries now, not to the country you were handed.', barNow:'The bar: {0}%',
  barHelp:'Every good stretch raises what counts as good enough, and it never drops back. Wages that felt generous become normal, calm becomes expected, and crises hit a country that has more to lose. Winning early makes the rest harder — that is the job.',
  ...
  portsTitle:'Export capacity', portsSub:'Ports and border crossings limit how much you can sell abroad.', portsUse:'Exports want {0} every 12 months. Ports and crossings can move {1}.',
  clogged:'Ports are jammed: {0} of exports every 12 months can’t leave the country.', portLvl:'Size {0} of 3', portState:'Run by the state', portForeign:'Run by a foreign operator',
...
Object.assign(STR.ar, {
  ...
  afterN:'بعد {0} في الرئاسة', missionsTxt:'تحديات من 48 شهراً، كل واحد يعلّم نظاماً واحداً.', seasonsLeft:'بقي {0}', quiet:'شهر هادئ.',
  choices:'قراراتك', monthsN:'{0} أشهر', months1:'شهر واحد', soon:'خلال أيام', inTime:'خلال {0}',
  ...
  inSixMonths:'خلال 6 أشهر', perYear:'كل 12 شهراً', monthNo:'الشهر {0}',
  level:'المستوى', levelN:'المستوى {0}', levelOf10:'المستوى {0} من 10',
  ...
  decFx:'الدولارات تتكدّس في المصرف بينما الموازنة بلا ليرات',
  ...
  chain6:'ناس يعملون ← محلات لديها زبائن ← ضرائب تستطيع الدولة جبايتها فعلاً ← رواتب تُدفع بالليرة',
  chainHelp:'لا شيء في هذا البلد له أثر واحد فقط. هذه هي اللعبة كلها.',
  taxBase:'ما يمكنك جبايته في الداخل',
  taxBaseTxt:'النفط والفوسفات يدفعان لك بالدولار. الليرة تأتي من ناس لديهم عمل ثابت، ومحلات لديها زبائن، ومصانع تمسك دفاتر. كل مصنع تفتحه وكل شخص يعود إلى العمل يكبّر هذا الرقم.',
  taxBaseNow:'{0}% مما كان عليه عندما بدأتَ',
  taxBaseFirms:'مصانع تدفع ضريبة الشركات: {0}',
  taxBaseJobs:'{0} من كل 100 شخص في سنّ العمل بلا عمل ثابت',
  giftFx:'بيع الدولارات مقابل الليرة',
  ...
  svcSchoolsTxt:'صفوف ومعلّمون وكتب لأطفال خسروا الكثير من الدراسة في الحرب.',
  svcClinicsTxt:'أطباء ودواء وسرير مشفى في المتناول. تكلّف دولارات كل شهر لتبقى تعمل.',
  ...
  barHigh:'الناس يقارنونك الآن بالدول الطبيعية، لا بالبلد الذي تسلّمته.', barNow:'السقف: {0}%',
  barHelp:'كل فترة جيدة ترفع ما يُعتبر «جيداً بما يكفي»، ولا يعود إلى الوراء أبداً. الراتب الذي بدا سخياً يصير عادياً، والهدوء يصير متوقعاً، والأزمات تضرب بلداً صار لديه ما يخسره. النجاح المبكر يجعل ما بعده أصعب، وهذه هي المهمة.',
  ...
  portsTitle:'قدرة التصدير', portsSub:'الموانئ والمعابر الحدودية تحدّد كم يمكنك أن تبيع للخارج.', portsUse:'الصادرات تحتاج {0} كل 12 شهراً. الموانئ والمعابر تنقل {1}.',
  clogged:'الموانئ مزدحمة: صادرات بقيمة {0} كل 12 شهراً لا تستطيع مغادرة البلاد.', portLvl:'الحجم {0} من 3', portState:'تديره الدولة', portForeign:'يديره مشغّل أجنبي',
...
POL.capex.en = { name:'Build power stations', q:'How many dollars go into electricity every 12 months? New power arrives 12 months later.', opts:{ 0:'$0', 20:'$40M', 40:'$80M' }, hint:{ 0:'Nothing. The grid slowly breaks down.', 20:'Steady progress. New power starts arriving in 12 months.', 40:'Fast progress. The best long-term move, but you wait 12 months to see it.' } };
POL.capex.ar = { name:'بناء محطات الكهرباء', q:'كم دولاراً يذهب إلى الكهرباء كل 12 شهراً؟ الكهرباء الجديدة تصل بعد 12 شهراً.', opts:{ 0:'0$', 20:'40 مليون$', 40:'80 مليون$' }, hint:{ 0:'لا شيء. الشبكة تتهالك ببطء.', 20:'تقدّم ثابت. الكهرباء الجديدة تبدأ بالوصول بعد 12 شهراً.', 40:'تقدّم سريع. أفضل خطوة للمستقبل، لكنك تنتظر 12 شهراً لترى النتيجة.' } };
POL.recon.en.q = 'How much cash goes to rebuilding every 12 months?'; POL.recon.en.opts = { 0:'None', 5:'10bn', 10:'20bn', 20:'40bn' };
POL.recon.ar.q = 'كم من النقد يذهب لإعادة الإعمار كل 12 شهراً؟'; POL.recon.ar.opts = { 0:'لا شيء', 5:'10 مليار', 10:'20 مليار', 20:'40 مليار' };
POL.print.en.opts = { 0:'None', 5:'10bn', 15:'30bn', 30:'60bn' }; POL.print.ar.opts = { 0:'لا', 5:'10 مليار', 15:'30 مليار', 30:'60 مليار' };
POL.print.en.q = 'Print new lira every 12 months to pay the bills?'; POL.print.ar.q = 'هل تطبع ليرات جديدة كل 12 شهراً لدفع الفواتير؟';
POL.intervene.en.opts = { 0:'None', 25:'$50M', 50:'$100M' }; POL.intervene.ar.opts = { 0:'لا', 25:'50 مليون$', 50:'100 مليون$' };
POL.intervene.en.q = 'Sell dollars every 12 months to stop the lira falling?'; POL.intervene.ar.q = 'هل تبيع دولارات كل 12 شهراً لمنع هبوط الليرة؟';
POL.intervene.en.hint = { 0:'Let the market decide.', 25:'Sell $50M every 12 months to hold the dollar price down.', 50:'Sell $100M every 12 months. Works, but burns your dollars.' };
POL.intervene.ar.hint = { 0:'دع السوق يقرّر.', 25:'بِع 50 مليون$ كل 12 شهراً لكبح سعر الدولار.', 50:'بِع 100 مليون$ كل 12 شهراً. ينجح لكنه يستنزف دولاراتك.' };
...
DEC_TXT.vocational.en[2] = 'Unemployment falls a little every month, everywhere. Costs $20M every 12 months.'; DEC_TXT.vocational.ar[2] = 'البطالة تنخفض قليلاً كل شهر في كل مكان. تكلّف 20 مليون$ كل 12 شهراً.';
...
Object.assign(ADV.en, {
  ...
  school:'A generation is growing up without school. You will feel it in 120 months, and so will they.', schoolAct:'Build schools under People → Schools & clinics.',
  ...
  usd:'Dollars will run out in about {0} months. That’s game over.', payAct:'A 10% raise in the Money panel. It costs cash every month after.', gridAct:'Put $40M or $80M every 12 months into power stations. It pays off in 12 months.', calmEcon:'The money looks okay right now.', calmEconAct:'Look at Trade: oil, ports and deals can bring in dollars.',
...
Object.assign(ADV.ar, {
  ...
  school:'جيل يكبر بلا مدرسة. ستشعر بذلك بعد 120 شهراً، وسيشعرون هم أكثر.', schoolAct:'ابنِ مدارس من الناس ← المدارس والعيادات.',
  ...
  usd:'ستنفد الدولارات خلال {0} أشهر تقريباً. عندها تنتهي اللعبة.', payAct:'زيادة 10% من لوحة المال. تكلّف نقداً كل شهر بعدها.', gridAct:'خصّص 40 أو 80 مليون$ كل 12 شهراً للمحطات. تُثمر خلال 12 شهراً.', calmEcon:'الوضع المالي مقبول الآن.', calmEconAct:'انظر إلى التجارة: النفط والموانئ والاتفاقات تجلب الدولار.',
...
Object.assign(WHY.en, { clogged:'Ports jammed', lostExports:'Lost exports {0} every 12 months', oilSold:'Oil sold abroad', oilHome:'Oil used at home' });
Object.assign(WHY.ar, { clogged:'الموانئ مزدحمة', lostExports:'صادرات ضائعة {0} كل 12 شهراً', oilSold:'النفط يُباع للخارج', oilHome:'النفط يُستخدم محلياً' });
...
MISSION_TXT.winter.en[1] = 'The grid is failing. Reach 7 hours of electricity a day within 48 months, with no province in revolt.';
MISSION_TXT.winter.ar[1] = 'الشبكة تنهار. اوصل إلى 7 ساعات كهرباء يومياً خلال 48 شهراً دون تمرّد أي محافظة.';
MISSION_TXT.lira.en[1] = 'The last government printed money like crazy. A dollar costs 260 lira and prices rise 90% every 12 months. Within 48 months, get the dollar under 340 and price rises under 30%.';
MISSION_TXT.lira.ar[1] = 'الحكومة السابقة طبعت النقود بجنون. الدولار بـ260 ليرة والأسعار ترتفع 90% كل 12 شهراً. خلال 48 شهراً، اجعل الدولار تحت 340 والتضخم تحت 30%.';
MISSION_TXT.bread.en[1] = 'Drought has hit the northeast. Wheat imports cost double for 48 months. Finish with trust at 40+, at least $250M in the bank, and Hasakeh’s anger below 55.';
MISSION_TXT.bread.ar[1] = 'ضرب الجفاف الشمال الشرقي. استيراد القمح يكلّف الضعف لمدة 48 شهراً. أنهِ المهمة بثقة 40+ و250 مليون$ على الأقل وغضب الحسكة تحت 55.';
MISSION_TXT.capital.en[1] = 'Rural Damascus is close to revolt and the city is restless. Within 48 months, get Rural Damascus under 50 and Damascus city under 45.';
MISSION_TXT.capital.ar[1] = 'ريف دمشق على وشك التمرّد والمدينة متوترة. خلال 48 شهراً، اجعل غضب ريف دمشق تحت 50 ومدينة دمشق تحت 45.';
MISSION_TXT.trade = { icon:'🚢', en:['Open for business','Syria earns about $120M every 12 months from exports, transit and investment. Within 48 months, get it to $250M.','Lesson: selling abroad needs things to sell, ports to ship them, and partners to buy them.'],
  ar:['البلد مفتوح للأعمال','تكسب سوريا حوالي 120 مليون$ كل 12 شهراً من الصادرات والعبور والاستثمار. خلال 48 شهراً، اوصل بها إلى 250 مليون$.','الدرس: البيع للخارج يحتاج بضاعة تبيعها، وموانئ تشحنها، وشركاء يشترونها.'] };
...
const INV_TXT = {
  ...
  offshore:{ icon:'🌊', en:['Drill for offshore gas','A 50/50 bet. In 36 months you find a big gas field under the sea, or nothing.'], ar:['التنقيب عن الغاز البحري','مقامرة 50/50. خلال 36 شهراً تجد حقل غاز كبيراً تحت البحر، أو لا شيء.'] },
...
Object.assign(INV_TXT, {
  ...
  food:{ icon:'🥫', en:['Food processing and canning','Turn the harvest into something that keeps. Jobs in the farming provinces, and a smaller wheat bill every month.'],
    ar:['تصنيع الأغذية والتعليب','حوّل المحصول إلى شيء يُخزَّن. وظائف في محافظات الزراعة، وفاتورة قمح أقل كل شهر.'] },
...
const PART_TXT = {
  turkey:{ en:['Turkey','Northern trade corridor','Open the northern crossings for factory and farm exports.','Export room +$60M every 12 months, factory exports +15%.','Aleppo and Idlib anger below 65'],
    ar:['تركيا','ممر التجارة الشمالي','فتح المعابر الشمالية لصادرات المصانع والمزارع.','قدرة تصدير +60 مليون$ كل 12 شهراً، صادرات المصانع +15%.','غضب حلب وإدلب أقل من 65'] },
  jordan:{ en:['Jordan','Southern route to the Gulf','Trucks carry goods through Nassib to Gulf markets.','Transit +$40M and export room +$50M, every 12 months.','Daraa anger below 65'],
    ar:['الأردن','الطريق الجنوبي إلى الخليج','شاحنات تنقل البضائع عبر نصيب إلى أسواق الخليج.','عبور +40 مليون$ وقدرة تصدير +50 مليون$، كل 12 شهراً.','غضب درعا أقل من 65'] },
  iraq:{ en:['Iraq','Oil and electricity link','Iraq sells you electricity and crude oil for your refineries.','+300 MW of power, fuel savings $20M every 12 months. Costs $30M every 12 months.','Deir ez-Zor anger below 65'],
    ar:['العراق','ربط النفط والكهرباء','العراق يبيعك الكهرباء والنفط الخام لمصافيك.','+300 ميغاواط، توفير وقود 20 مليون$ كل 12 شهراً. يكلّف 30 مليون$ كل 12 شهراً.','غضب دير الزور أقل من 65'] },
  lebanon:{ en:['Lebanon','Gas and power transit','Repair the Arab Gas Pipeline so gas and electricity can cross Syria to Lebanon.','Transit fees +$24M every 12 months. Pipeline repair costs $40M.','Homs anger below 70'],
    ar:['لبنان','عبور الغاز والكهرباء','أصلِح خط الغاز العربي ليعبر الغاز والكهرباء سوريا إلى لبنان.','رسوم عبور +24 مليون$ كل 12 شهراً. إصلاح الخط يكلّف 40 مليون$.','غضب حمص أقل من 70'] },
  gulf:{ en:['Gulf states','Investment partnership','Gulf funds invest in hotels, factories and farms.','+$80M of investment every 12 months, faster growth. Independence −2.','Corruption below 55'],
    ar:['دول الخليج','شراكة استثمارية','صناديق خليجية تستثمر في الفنادق والمصانع والمزارع.','+80 مليون$ استثمار كل 12 شهراً، ونمو أسرع. الاستقلال −2.','فساد أقل من 55'] },
  eu:{ en:['European Union','Market access and rebuilding','Syrian goods enter European markets, plus reconstruction grants.','Exports earn 25% more, +$60M in grants every 12 months.','Trust 45+ and corruption below 50'],
    ar:['الاتحاد الأوروبي','دخول الأسواق وإعادة الإعمار','البضائع السورية تدخل الأسواق الأوروبية، مع منح لإعادة الإعمار.','الصادرات تكسب 25% أكثر، +60 مليون$ منحاً كل 12 شهراً.','ثقة 45+ وفساد أقل من 50'] },
...
// Tapping the badge explains the level as well as the score behind it.
GLOSS.score.en.name = 'Level and legacy score'; GLOSS.score.ar.name = 'المستوى ونقاط الإرث';
GLOSS.score.en.what += ' ' + STR.en.levelHelp; GLOSS.score.ar.what += ' ' + STR.ar.levelHelp;
