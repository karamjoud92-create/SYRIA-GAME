...
const PARTNERS = {
 turkey:{ flag:'flag', pc:15, sov:1, ok:s => s.provs.aleppo.u < 65 && s.provs.idlib.u < 65 },
 jordan:{ flag:'flag', pc:10, sov:0, ok:s => s.provs.daraa.u < 65 },
 iraq:{ flag:'flag', pc:12, sov:0, ok:s => s.provs.deir.u < 65 },
 lebanon:{ flag:'flag', pc:8, sov:0, usd:40, ok:s => s.provs.homs.u < 70 },
 gulf:{ flag:'palm', pc:15, sov:2, ok:s => s.corr < 55 },
 eu:{ flag:'flag', pc:20, sov:1, ok:s => s.trust >= 45 && s.corr < 50 && s.sov >= 30, signReq:s => s.trust >= 45 && s.corr < 50 && s.sov >= 30 },
 china:{ flag:'flag', pc:10, sov:5, ok:() => true },
 russia:{ flag:'wheat', pc:8, sov:5, ok:() => true },
};
