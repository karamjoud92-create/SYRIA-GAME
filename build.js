...
const UI = ['text/1-ui-strings.js', 'text/2-content.js', 'text/3-stories.js', 'text/4-time-trade.js', 'text/5-multiplayer.js', 'text/6-levels.js',
  'net/net.js',
  'ui/0-sfx.js', 'ui/1-core.js', 'ui/2-map-panels.js', 'ui/3-board.js', 'ui/4-modals.js', 'ui/5-game.js', 'ui/6-multiplayer.js', 'ui/7-decisions.js', 'ui/8-levels.js'];
